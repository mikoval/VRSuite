...
function Floor(res, pathsize, type){
	...
	this.densityA = new THREE.WebGLRenderTarget( fluidWidth , fluidHeight, {type: THREE.UnsignedByteType,});
	this.densityB = new THREE.WebGLRenderTarget( fluidWidth , fluidHeight, {type: THREE.UnsignedByteType} );
	...
	this.addColor = function(x, y, color){
		...
		renderer.render(this.addDensityScene,this.fluidCamera,this.densityB,false);
		this.swapDensity();
    ...
    console.log("erasing scene");
    renderer.render(this.eraseScene,this.fluidCamera,this.densityB,false);
    this.swapDensity();
    this.update();
}
