...
renderer.shadowMapSoft = true;
	...
	model = undefined;
 	...
 	objloader.load( "/pool/Chocolatedonut.json", addDonutModelChocolateToScene );
 	 	objloader.load( "/pool/sprinkleDonut.json", addDonutModelCosmicToScene );
...
function adjustTexture(texture){
 ...
 function addDonutModelPinkToScene( geometry, materials ) {
  ...
  function addDonutModelChocolateToScene( geometry, materials ) {
   ...
   function addDonutModelCosmicToScene( geometry, materials ) {

 	var material = new THREE.MeshFaceMaterial(materials);
	model = new THREE.Mesh( geometry, material );

	donutModelCosmic= model;
 }
...
function checkLoaded(){
	...
	if(donutCollider != undefined && donutModelPink != undefined && donutModelChocolate != undefined && donutModelCosmic != undefined && cupModel != undefined && cupCollider != undefined){
		createScene();
	}
	else{
